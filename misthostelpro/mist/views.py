        ...
        if int(request.user.profilupdate.MealBill) > 0 or request.user.profilupdate.permission==True:
            ...
            #Available Meal####################
                ...
                try:
                    ...
                    order=Demo(Name=request.user.first_name + request.user.last_name,Roll=request.user,Hostel=request.user.profilupdate.Hostel,Room_Number=request.user.profilupdate.Room_Number,Break_qun=1,Break=Oname,Break_price=price,Date_Time=Odate)
                    order.save()
            #Meal Bill################################
        ...
        if int(request.user.profilupdate.MealBill) > 0 or request.user.profilupdate.permission==True:
            ...
            #Available Meal####################
                ...
                try:
                    ...
                    order=Demo(Name=request.user.first_name + request.user.last_name,Roll=request.user,Hostel=request.user.profilupdate.Hostel,Room_Number=request.user.profilupdate.Room_Number,Lunch_qun=1,Lunch=Oname,Lunch_price=price,Date_Time=Odate)
                    order.save()
            #Meal Bill################################
                mealbillMinus=ProfilUpdate.objects.filter(user=request.user)
                for i in mealbillMinus:
        ...
        if int(request.user.profilupdate.MealBill) > 0 or request.user.profilupdate.permission==True:
            ...
            #Available Meal####################
                ...
                try:
                    ...
                    order=Demo(Name=request.user.first_name + request.user.last_name,Roll=request.user,Hostel=request.user.profilupdate.Hostel,Room_Number=request.user.profilupdate.Room_Number,Denar_qun=1,Denar=Oname,Denar_price=price,Date_Time=Odate)
                    order.save()
                #Meal Bill################################
                mealbillMinus=ProfilUpdate.objects.filter(user=request.user)
                for i in mealbillMinus:
...
def makepayment(request):
    if request.user.is_superuser:
        if request.method=="POST":
            ...
            try:
                search=ProfilUpdate.objects.get(Class_Roll=userrol)
                Name=search.StudentName
                Mobile=search.Numer
                search.MealBill = int(search.MealBill) + int(food)
                search.save()
...
def Alluser(request):
    if request.user.is_authenticated:
        ...
        if request.method=="POST":
            prmition=ProfilUpdate.objects.get(Class_Roll=getuser)
